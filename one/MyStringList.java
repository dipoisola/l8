...
public class MyStringList {
	...
	public static void main(String[] args) {
		...
		stringList.add("enormous");
		stringList.add("tiny");
		stringList.add("gargantuan");
		stringList.add("lilliputian");
		stringList.add("numberless");
		stringList.add("none");
		stringList.add("vast");
		stringList.add("minuscle");

		System.out.println(stringList);
		stringList.sort();
		System.out.println(stringList);
		
		System.out.println(stringList.search("tiny")); //true
		System.out.println(stringList.search("number")); //false
	}
